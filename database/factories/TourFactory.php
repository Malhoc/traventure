...
class TourFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'image' =>  'images/tours/' . $this->faker->image('public/storage/images/tours', 1920, 509, null, false),
            'thumbnail' => 'images/tours/' . $this->faker->image('public/storage/images/tours', 310, 291, null, false),

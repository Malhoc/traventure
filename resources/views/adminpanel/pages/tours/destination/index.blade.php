...
@section('title-meta')
    <title>{{config('app.name')}} | Destinations List</title>
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-sm-8">
                <div class="title-action">
                    <a href="{{ route('admin.tours.destination.create') }}" class="btn btn-primary">+ Create New</a>
                </div>
            </div>
        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        @foreach ($destinations as $destination)
                                            <tr class="gradeX" id="row-{{ $destination->id }}">
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="{{ route('admin.tours.destination.edit', $destination) }}"
                                                            class="btn-white btn btn-xs">Edit</a>
                                                        <button onclick="deleteRecord({{ $destination->id }})"
        ...
        function deleteRecord(id) {
            swal({
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.tours.destination.destroy', '') }}/" + id,
